          ...
          >
            {infoList.map(({ icon, iconDark, title, description }, index) => (
              <motion.li
                ...
                key={index}
                className="border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 shadow-boxShadow hover:shadow-black dark:border-white dark:hover:shadow-white dark:shadow-darkTheme dark:hover:bg-darkHover/50"
              >
                <Image
