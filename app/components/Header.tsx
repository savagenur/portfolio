  ...
  return (
    <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
      ...
      className="max-w-2xl mx-auto font-ovo">
        I am a frontend developer from Portland, USA with 4 years of experience
        in web design and development. I create modern and responsive websites
